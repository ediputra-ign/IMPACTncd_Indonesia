    ...
    private = list(
      ...
      gen_synthpop = # returns NULL. Writes synthpop on disk
        function(mc_,
          ...
          #      fifelse(ssb_level_int == 2, 1.52,
          #      fifelse(ssb_level_int == 3, 3.04,
          #      fifelse(ssb_level_int == 4, 4.56,
          ...
          dt[, ssb := ssb_values[ssb_level_int]]
          ...
          if ("age90" %in% names(dt)) {
            dt[, age := NULL]
            setnames(dt, "age90", "age")
          }
          dt[, sex := factor(sex)]
