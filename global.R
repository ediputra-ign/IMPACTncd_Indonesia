## IMPACTncd_Indonesia is an implementation of the IMPACTncd framework, developed by Chris
## Kypridemos with contributions from Peter Crowther (Melandra Ltd), Maria
## Guzman-Castillo, Amandine Robert, and Piotr Bandosz.
##
## Copyright (C) 2018-2020 University of Liverpool, Chris Kypridemos
##
## IMPACTncd_Indonesia is free software; you can redistribute it and/or modify it under
...
# file.remove(list.files("./Rpackage/IMPACTncd_Indonesia_model_pkg/src", full.names = TRUE, recursive = TRUE, pattern = "\\.o$|\\.so$"))
...
cat("Initialising IMPACTncd_Indonesia model...\n\n")
...
withCallingHandlers({
  installLocalPackageIfChanged(
    pkg_path = "./Rpackage/IMPACTncd_Indonesia_model_pkg/",
    snapshot_path = "./Rpackage/.IMPACTncd_Indonesia_model_pkg_snapshot.rds"
  )
}, warning = function(w) {
