  ...
  R6::R6Class(
    ...
    public = list(
        ...
        for (age_ in age_start:self$design$sim_prm$ageH) {
          ...
          unclbr <- unclbr[,
            .(
              ...
              t2dm_incd = t2dm_incd / popsize #edited 20260210
            )
          ][,
            .(
              chd_incd = memedian(chd_incd),
              stroke_incd = memedian(stroke_incd),
              t2dm_incd = memedian(t2dm_incd) #edited 20260210
            ),
            keyby = .(age, sex, year)
          ]
          ...
          #  t2dm_prvl = t2dm_prvl / popsize, #edited 20260210
            popsize,
            age,
            sex,
            year,
            ...
            #  t2dm_prvl = memedian(t2dm_prvl), #edited 20260210
          ...
          benchmark <- read_fst( #ask Chris: so we don't need to do t2dm_mrtl?
      ...
      validate = function() {
        ...
        setDT(mdd)
        mdd[, `:=`(
          nonmodelled_mrtl_rate = nonmodelled_deaths / popsize, #ask Chris: no t2dm here?
        ...
        mdd[, `:=`(
          ...
          t2dm_incd_rate = t2dm_incd / popsize #edited 20260210
        )]
        mdd <- mdd[,
          .(
            ...
            t2dm_incd_rate = quantile(t2dm_incd_rate, p = 0.500), #edited 20260210
            t2dm_incd_rate_low = quantile(t2dm_incd_rate, p = 0.025), #edited 20260210
            t2dm_incd_rate_upp = quantile(t2dm_incd_rate, p = 0.975), #edited 20260210
            type = "modelled"
          ),
          keyby = .(year, agegrp, sex)
        ]
        ...
        mdd[, `:=`(
         ...
         # t2dm_prvl_rate = t2dm_prvl / popsize #edited 20260210
        )]
        mdd <- mdd[,
          .(
            ...
            # t2dm_prvl_rate = quantile(t2dm_prvl_rate, p = 0.500), #edited 20260210
            # t2dm_prvl_rate_low = quantile(t2dm_prvl_rate, p = 0.025), #edited 20260210
            # t2dm_prvl_rate_upp = quantile(t2dm_prvl_rate, p = 0.975), #edited 20260210
            type = "modelled"
          ),
          keyby = .(year, agegrp, sex)
        ]
